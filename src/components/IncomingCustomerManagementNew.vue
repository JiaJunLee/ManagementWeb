<template>
    <div style="width: 100%;">
        ...
        <el-table border stripe size="mini" style="width: 100%;" :height="tableHeight" :data="customers.filter(data => !search || data.name.toLowerCase().includes(search.trim().toLowerCase()))" v-loading="onLoading" @selection-change="(selected) => { selectedCustomers = selected }">
            ...
            <el-table-column fixed prop="customerTypeId" label="客户类型" width="200"
            ...
            <el-table-column fixed prop="phoneNumber" label="联系电话" width="200"></el-table-column>
            ...
            <el-table-column label="操作"  v-if="that.$store.state.user.type === 'ADMINISTRATOR'" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="`客户 - ${ customerForRemarksDialog.name } - 备注`" :visible.sync="remarksDialogVisible" v-if="customerForRemarksDialog">
            ...
            <el-table :data="customerForRemarksDialog.remarksNew" border height="400">
                ...
                <el-table-column label="职员姓名" width="200">
                    <template slot-scope="scope">
        ...
        <el-dialog title="批量设置可见用户组" width="36%" :visible.sync="batchJoinUserGroupsDialogVisible">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="batchJoinUserGroups">确 定</el-button>
            </span>
        </el-dialog>
        ...
        <el-dialog title="设置可见用户组" width="36%" :visible.sync="joinUserGroupsDialogVisible">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="joinUserGroups">确 定</el-button>
            </span>
        </el-dialog>
    ...
    export default {
        ...
        data () {
          return {
              ...
              batchJoinUserGroupsCustomerIds: [],
